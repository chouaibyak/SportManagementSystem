...
public class MemberPerformanceController {
    ...
    @FXML private BarChart<String, Number> chartComparaison;
    
    // Statistiques actuelles
    @FXML private Label lblPoidsActuel;
    @FXML private Label lblIMCActuel;
    @FXML private Label lblTourTailleActuel;
    @FXML private Label lblForceActuelle;
    @FXML private Label lblEnduranceActuelle;
    
    // Évolutions
    @FXML private Label lblEvolutionPoids;
    @FXML private Label lblEvolutionIMC;
    @FXML private Label lblEvolutionTourTaille;
    @FXML private Label lblDateDerniereMesure;
    
    // Objectifs
    @FXML private Label lblObjectifPoids;
    @FXML private ProgressBar progressPoids;
    @FXML private Label lblProgressPourcentage;
    
    // Tableau historique
    @FXML private TableView<PerformanceDisplay> tableHistorique;
    @FXML private TableColumn<PerformanceDisplay, String> colDate;
    @FXML private TableColumn<PerformanceDisplay, String> colPoids;
    @FXML private TableColumn<PerformanceDisplay, String> colIMC;
    @FXML private TableColumn<PerformanceDisplay, String> colTourTaille;
    @FXML private TableColumn<PerformanceDisplay, String> colForce;
    @FXML private TableColumn<PerformanceDisplay, String> colEndurance;
    
    // Filtres
    @FXML private ComboBox<String> comboPeriode;
    @FXML private TextField txtPoidsObjectif;
...
private void afficherErreur(String titre, String msg) {
    ...
    private List<Performance> filtrerParPeriode(List<Performance> historique) {
        if (historique.isEmpty()) return historique;
    ...
    private void calculerProgression(List<Performance> historique) {
        ...
        lblEvolutionPoids.setStyle(evolutionPoids < 0 ? 
        ...
        lblEvolutionIMC.setStyle(evolutionIMC < 0 ? 
            "-fx-text-fill: #27ae60; -fx-font-weight: bold;" : 
            "-fx-text-fill: #e74c3c; -fx-font-weight: bold;");
        ...
        lblEvolutionTourTaille.setStyle(evolutionTaille < 0 ? 
            "-fx-text-fill: #27ae60; -fx-font-weight: bold;" : 
            "-fx-text-fill: #e74c3c; -fx-font-weight: bold;");
    ...
    private void calculerObjectifPoids(double poidsActuel) {
        ...
        try {
            ...
            double poidsDepart = historiqueComplet.isEmpty() ? poidsActuel : 
                                 historiqueComplet.get(0).getPoids();
    ...
    private void handleExporter() {
        ...
        alert.setContentText("L'export des performances sera bientôt disponible !");
        alert.showAndWait();
    }
    ...
    public static class PerformanceDisplay {
        ...
        public String getTourTaille() { return tourTaille; }
